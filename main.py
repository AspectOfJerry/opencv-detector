...
while True:
 ...
 # convert the input image to the HSV color space
    ...
    img_threshold = ocv.inRange(img_hsv, (35, 100, 100), (40, 100, 25))

    # find contours in the new binary image
    contours, _ = ocv.findContours(img_threshold,
    ocv.RETR_EXTERNAL, ocv.CHAIN_APPROX_SIMPLE)
    ...
    ocv.imshow("Limelight ocv test (CPU) Preview", img_threshold)
    ocv.waitKey(1)
